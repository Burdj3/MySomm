...
public class MainActivity extends AppCompatActivity {
    ...
    public void fillDatabase()
    {
        ...
        dbHelper.saveToLocalDatabase("Marqués del Atrio Rioja Reserva","Carignan","Sweet","This one of Spain’s best values of the year, a 93-point Reserva at a price that you almost never see.","Heavy","Red","Spain","Very","Less than $20","https://dco67j8qsiydp.cloudfront.net/images/products/2021/03/atrio_Bottleshot_compressed.png");
        dbHelper.saveToLocalDatabase("Tokaj Oremus Tokaji","Tokaji","Sweet","Tokaji is a cellar essential, especially when it comes from Vega Sicilia-backed Oremus.","Light","White","Hungary","Not Very","Greater than $20","https://dco67j8qsiydp.cloudfront.net/images/products/2020/09/2010_Tokaj_Oremus_Tokaji_Aszu_5_Puttonyos_Tokaj_Hungary_bottle_compressed.jpg");
        dbHelper.saveToLocalDatabase("Dr. Pauly-Bergweiler Riesling","Riesling","Sweet","Luscious perfection made from the top vineyard in the peak region for Riesling","Medium","White","Germany","Not Very","Greater than $20","https://dco67j8qsiydp.cloudfront.net/images/products/2021/03/2018_Dr._Pauly-Bergweiler_Wehlener_Sonnenuhr_Kabinett_Riesling_Mosel__bottle_compressed.png");
        dbHelper.saveToLocalDatabase("Paxton MV Shiraz McLaren Vale","Shiraz","Sweet","Wines from Paxton grapes are hot-ticket collector items—the coveted Mollydooker Velvet Glove Shiraz costs $195.","Light","Red","Australia","Not Very","Greater than $20","https://dco67j8qsiydp.cloudfront.net/images/products/2021/01/2019_Paxton_MV_Shiraz_McLaren_Vale_Australia_bottle_compressed.png");
        dbHelper.saveToLocalDatabase("Le Grand Bouqueteau","Cabernet Franc","Sweet","This Cab Franc is a delicious lesson in all that makes the Loire Valley so special.","Medium","Red","France","Not Very","Greater than $20","https://dco67j8qsiydp.cloudfront.net/images/products/2019/12/Chinon_compressed.jpg");
        ...
        dbHelper.saveToLocalDatabase("Grosset Wines Alea","Riesling","Sweet","Grosset is one of Australia’s iconic producers—the undisputed master of Riesling on the continent.","Light","White","Clare Valley","Somewhat","Greater than $20","https://dco67j8qsiydp.cloudfront.net/images/products/2021/02/2020_Grosset_Wines_Alea_Riesling_Clare_Valley_Australia_Bottleshot_compressed.png");
        ...
        dbHelper.saveToLocalDatabase("Dayna Estate","Cabernet Sauvignon","Sweet","From a seasoned Cabernet expert behind icons like Joseph Phelps, Chateau Montelena, and Robert Mondavi.","Light","Red","Napa Valley","Somewhat","Greater than $20","https://dco67j8qsiydp.cloudfront.net/images/products/2020/11/2018_Dayna_Estate_Cabernet_Sauvignon_Oak_Knoll_District_Napa_Valley_bottle_compressed.png");
        dbHelper.saveToLocalDatabase("Mas Roc de Bô Pepite","Syrah","Sweet","This is a dead-ringer for high-end Châteauneuf, with a price that’s pure Languedoc.","Medium","Red","France","Somewhat","Greater than $20","https://dco67j8qsiydp.cloudfront.net/images/products/2020/11/mas-roc-pepite_Bottleshot_compressed.png");
        dbHelper.saveToLocalDatabase("Famille Perrin","Cabernet Sauvignon","Sweet","Today’s 94pt Editors’ Choice Châteauneuf is from the same terroir and far less off a price!","Heavy","Red","France","Somewhat","Greater than $20","https://dco67j8qsiydp.cloudfront.net/images/products/2020/06/lessinards_Bottleshot_compressed.jpg");
        dbHelper.saveToLocalDatabase("Chateau Haut Bergeron","Semillion","Sweet","Decanter called it “pitch-perfect” while awarding it a 96-point score.","Medium","White","France","Very","Greater than $20","https://dco67j8qsiydp.cloudfront.net/images/products/2020/09/2016_Chateau_Haut-Bergeron_Sauternes_AOC_bottle_compressed.jpg");
        dbHelper.saveToLocalDatabase("Tasca d'Almerita","Catarratto","Sweet","In 2019, Tasca d’Almerita became the first Sicilian producer to earn a Wine Enthusiast Winery of the Year award.","Heavy","White","Italy","Very","Greater than $20","https://dco67j8qsiydp.cloudfront.net/images/products/2021/04/dAlmerita-catarratto_Bottleshot_compressed.png");

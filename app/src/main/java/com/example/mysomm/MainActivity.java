...
public class MainActivity extends AppCompatActivity {
    ...
    public void fillDatabase()
    {
        ...
        dbHelper.saveToLocalDatabase("Le Grand Bouqueteau Chinon","Cabernet Franc","Sweet","This Cab Franc is a delicious lesson in all that makes the Loire Valley so special.","Medium","Red","France","Not Very","Greater than $20","https://dco67j8qsiydp.cloudfront.net/images/products/2019/12/Chinon_compressed.jpg");

...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public Cursor readFromFilteredLocalDatabase2(String swt, String prce, String acd, String clr, String bdy)
    {
        ...
        else if (bdy.matches("Don't Care"))
        {
        ...
        else if (acd.matches("Don't Care"))
        {
        ...
        else if (swt.matches("Don't Care"))
        {
        ...
        else if (bdy.matches("Don't Care") && clr.matches("Either"))
        {
        ...
        else if (clr.matches("Either") && acd.matches("Don't Care"))
        {
        ...
        else if (acd.matches("Don't Care") && prce.matches("Any"))
        {
        ...
        else if (prce.matches("Any") && swt.matches("Don't Care"))
        {
        ...
        else if (swt.matches("Don't Care") && bdy.matches("Don't Care"))
        {
        ...
        else if (bdy.matches("Don't Care") && prce.matches("Any"))
        {
        ...
        else if (bdy.matches("Don't Care") && acd.matches("Don't Care"))
        {
        ...
        else if (clr.matches("Either") && prce.matches("Any"))
        {
        ...
        else if (clr.matches("Either") && swt.matches("Don't Care"))
        {
        ...
        else if (swt.matches("Don't Care") && acd.matches("Don't Care"))
        {
        ...
        else if (bdy.matches("Don't Care") && clr.matches("Either") && acd.matches("Don't Care"))
        {
        ...
        else if (bdy.matches("Don't Care") && clr.matches("Either") && prce.matches("Any"))
        {
        ...
        else if (bdy.matches("Don't Care") && clr.matches("Either") && swt.matches("Don't Care"))
        {
        ...
        else if (clr.matches("Either") && acd.matches("Don't Care") && prce.matches("Any"))
        {
        ...
        else if (clr.matches("Either") && acd.matches("Don't Care") && swt.matches("Don't Care"))
        {
        ...
        else if (swt.matches("Don't Care") && acd.matches("Don't Care") && prce.matches("Any"))
        {
        ...
        else if (bdy.matches("Don't Care") && acd.matches("Don't Care") && prce.matches("Any"))
        {
        ...
        else if (bdy.matches("Don't Care") && acd.matches("Don't Care") && prce.matches("Any") && clr.matches("Either"))
        {
        ...
        else if (swt.matches("Don't Care") && acd.matches("Don't Care") && prce.matches("Any") && clr.matches("Either"))
        {
        ...
        else if (swt.matches("Don't Care") && acd.matches("Don't Care") && bdy.matches("Don't Care") && clr.matches("Either"))
        {
        ...
        else if (swt.matches("Don't Care") && prce.matches("Any") && bdy.matches("Don't Care") && clr.matches("Either"))
        {
        ...
        else if (swt.matches("Don't Care") && acd.matches("Don't Care") && prce.matches("Any") && bdy.matches("Don't Care"))
        {
            Cursor res28 = database.rawQuery("select * from winesdb where where (SWEET = 'Dry' or SWEET = 'Between' or SWEET = 'Sweet') and (PRICE = 'Less than $20' or PRICE = 'Greater than $20') and (ACIDITY = 'Not Very' or ACIDITY = 'Somewhat' or ACIDITY = 'Very') and COLOR = '"+clr+"' and (BODY = 'Light' or BODY = 'Medium' or BODY = 'Heavy')", null);
            return res28;
        }
        else
            {

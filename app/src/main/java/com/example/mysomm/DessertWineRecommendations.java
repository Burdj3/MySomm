...
public class DessertWineRecommendations extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wines.add(new Wine("Moscatel", "Type: White", "Taste: Sweet", "Ranging from chestnut to an intense mahogany in colour, with a pronounced density and tearing. The characteristic varietal notes of muscatel grapes stand out in the nose with the presence of the floral aromas of jasmine, orange blossom and honey suckle."));
        wines.add(new Wine("Moscato", "Type: White", "Taste: Sweet", "Moscato is a sweet, medium to low-acidity wine. This wine includes a fragrant aroma, and fruit such as peach, apricot, and orange citrus, and delicate floral notes such rose petal and elderflower."));
